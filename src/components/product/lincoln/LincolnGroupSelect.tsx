...
export function LincolnGroupSelect({ groups }: LincolnGroupSelectProps) {
  return (
    <div className="mt-8 max-w-md">
      <label htmlFor="lincoln-group-select" className="mb-2 block text-xs font-black uppercase tracking-[0.22em] text-slate-600">
        Select Product Group
      </label>
      <div className="relative">
        <select
          id="lincoln-group-select"
          defaultValue=""
          onChange={(event) => {
