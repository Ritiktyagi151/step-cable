      ...
      <section className="relative overflow-hidden bg-slate-950 px-4 py-14 text-white sm:px-6 sm:py-18 lg:px-8 lg:py-20">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="wire-page-rise max-w-4xl">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#5bd6ff]">Wire & Cable Catalogue</p>
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {[
              ...
              <div key={label as string} style={{ animationDelay: `${(index + 1) * 90}ms` }} className="wire-page-rise rounded-[8px] border border-white/15 bg-white/10 p-5 shadow-xl shadow-black/10 backdrop-blur">
                <Icon aria-hidden="true" className="text-2xl text-[#5bd6ff]" />
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="wire-page-rise flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.24em] text-[#0877ff]">Wire & Cable Range</p>
              <h2 className="mt-3 max-w-3xl text-3xl font-black leading-tight sm:text-5xl">
                Select a wire or cable to view complete details.
              </h2>
            </div>
            <a href="/contact" className="inline-flex w-fit items-center gap-2 rounded-full bg-[#0877ff] px-5 py-3 text-xs font-black uppercase tracking-[0.16em] text-white shadow-lg shadow-blue-500/20 transition hover:-translate-y-0.5 hover:bg-[#005fd0]">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {wireAndCableProducts.map((product, index) => (
              <a
                ...
                className="wire-page-rise group overflow-hidden rounded-[8px] border border-slate-200 bg-white shadow-xl shadow-slate-900/5 transition duration-300 hover:-translate-y-1 hover:border-[#0877ff]/35 hover:shadow-2xl hover:shadow-blue-500/10"
              >
                <div className="relative flex aspect-[4/3] items-center justify-center overflow-hidden bg-slate-50 p-4">
                  ...
                  <span className="absolute left-4 top-4 rounded-full bg-[#0877ff] px-3 py-1 text-xs font-black uppercase tracking-wide text-white">
                    {product.shortName}
                  </span>
                </div>
                <div className="p-5">
                  ...
                  <span className="mt-5 inline-flex items-center gap-2 text-sm font-black uppercase tracking-wide text-[#0877ff]">
