...
export function WireAndCableListingPage({ page }: WireAndCableListingPageProps) {
  return (
    <>
      <PageHero slug={page.slug} title="Wire and Cable Products" description={page.description} image={page.image || "/assets/img/cable-wires.jpg"} />
      <section className="bg-[#f5f4f1] py-12 text-slate-950 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 flex flex-col justify-between gap-4 sm:mt-16 lg:flex-row lg:items-end">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.24em] text-brand-dark">Wire & Cable Range</p>
