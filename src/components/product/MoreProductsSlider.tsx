        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <button
              ...
              className="inline-flex size-11 items-center justify-center rounded-[8px] border border-slate-200 bg-white text-slate-950 shadow-sm transition hover:border-[#2486FE]/40 hover:text-[#2486FE]"
            >
        ...
        >
          {products.map((product) => (
            <Link
              ...
              className="group flex min-h-[360px] w-[82vw] shrink-0 snap-start flex-col overflow-hidden rounded-[8px] border border-slate-200 bg-white shadow-lg shadow-slate-900/5 transition duration-300 hover:-translate-y-1 hover:border-[#2486FE]/35 hover:shadow-2xl hover:shadow-[#2486FE]/10 sm:w-[45%] lg:w-[calc((100%_-_3.75rem)/4)]"
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                <p className="text-[11px] font-black uppercase tracking-[0.2em] text-[#2486FE]">{product.code || fallbackCode}</p>
