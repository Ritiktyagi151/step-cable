...
export function CertificationsStandards() {
  ...
  return (
    <section ref={sectionRef} style={sectionBgStyle} className="relative overflow-hidden border-b border-brand-teal/15 text-slate-900">
      ...
      {/* <div className="absolute inset-0 bg-[linear-gradient(rgba(36,134,254,0.10)_1px,transparent_1px),linear-gradient(90deg,rgba(36,134,254,0.10)_1px,transparent_1px)] bg-[size:46px_46px]" /> */}
